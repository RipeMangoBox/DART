...
from mld.train_mvae_fd import Args as MVAEArgs
from mld.train_mvae_fd import DataArgs, TrainArgs
...
class Trainer:
    ...
    def train(self):
        ...
        while self.step <= total_steps:
            ...
            # t1 = time.time()
            # print('amp.autocast:', bool(train_args.use_amp))
            with amp.autocast(enabled=bool(train_args.use_amp), dtype=torch.float16):
